...
// The active category arrives as a prop from the server rather than from
// useSearchParams(). That hook forces its whole Suspense subtree to render
// client-side only, which meant /shop shipped "Loading creations" to crawlers
// with zero product markup and — worse — zero links to the 45 product pages.
